...
uint8_t SSD1306_Init(void) {
	...
	if (!i2cProvider.I2C_IsDeviceReady(SSD1306_I2C_ADDR, 1, 20000)) {
		/* Return false */
		return 0;
	}
...
for(i = 0; i < count; i++)
dt[i+1] = data[i];
i2cProvider.I2C_Master_Transmit(address, dt, count+1, 10);
}
...
void ssd1306_I2C_Write(uint8_t address, uint8_t reg, uint8_t data) {
	...
	dt[0] = reg;
	dt[1] = data;
	i2cProvider.I2C_Master_Transmit(address, dt, 2, 10);
}
